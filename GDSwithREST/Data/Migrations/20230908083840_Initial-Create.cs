        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorityId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HttpsCertificate = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    TrustListId = table.Column<int>(type: "int", nullable: false),
                    HttpsTrustListId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertificateSigningRequest = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    SubjectName = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    DomainNames = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PrivateKeyFormat = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    PrivateKeyPassword = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    AuthorityId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
