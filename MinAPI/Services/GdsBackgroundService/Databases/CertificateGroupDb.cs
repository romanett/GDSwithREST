...
namespace GDSwithREST.Services.GdsBackgroundService.Databases
{
    public class CertificateGroupDb: ICertificateGroupDb
    {
        ...
        public CertificateGroupDb()
        {
            UpdateRequired = false;
            Configuration = new CertificateGroupConfiguration();
        }
            ...
            string privateKeyPassword)
        {
                ...
                .CreateForRSA())
            {
                ...
                {
                    throw new ServiceResultException(Opc.Ua.StatusCodes.BadInvalidArgument, "Invalid private key format");
                }
            ...
            byte[] certificateRequest)
        {
            try
            {
                ...
                {
                    throw new ServiceResultException(Opc.Ua.StatusCodes.BadInvalidArgument, "CSR signature invalid.");
                }
                ...
                if (altNameExtension != null)
                {
                    if (altNameExtension.Uris.Count > 0)
                    {
                        ...
                        {
                            throw new ServiceResultException(Opc.Ua.StatusCodes.BadCertificateUriInvalid,
            ...
            catch (Exception ex)
            {
                ...
                {
                    throw (ServiceResultException)ex;
                }
                throw new ServiceResultException(Opc.Ua.StatusCodes.BadInvalidArgument, ex.Message);
            }
        }
            ...
            )
        {
            ...
            var authority = X509Extensions.FindExtension<Opc.Ua.Security.Certificates.X509AuthorityKeyIdentifierExtension>(certificate);
            if (authority != null)
            {
            ...
            if (!isCACert)
            {
                ...
                {
                    throw new ServiceResultException(Opc.Ua.StatusCodes.BadCertificateInvalid, "Cannot revoke self signed certificates");
                }
            }
            ...
            using (ICertificateStore store = CertificateStoreIdentifier.OpenStore(storePath))
            {
                ...
                if (certCA == null)
                {
                    throw new ServiceResultException(Opc.Ua.StatusCodes.BadCertificateInvalid, "Cannot find issuer certificate in store.");
                }
                ...
                {
                    throw new ServiceResultException(Opc.Ua.StatusCodes.BadCertificateInvalid, "Failed to load issuer private key. Is the password correct?");
                }

                if (!certCAWithPrivateKey.HasPrivateKey)
                {
                    throw new ServiceResultException(Opc.Ua.StatusCodes.BadCertificateInvalid, "Issuer certificate has no private key, cannot revoke certificate.");
                }
        ...
        protected X509SubjectAltNameExtension? GetAltNameExtensionFromCSRInfo(Org.BouncyCastle.Asn1.Pkcs.CertificationRequestInfo info)
        {
            ...
            {
                throw new ServiceResultException(Opc.Ua.StatusCodes.BadInvalidArgument, "CSR altNameExtension invalid.");
            }
            return null;
        }
        #endregion
